...
public final class Bundles {
     ...
     * parameter
     *
     * @param bundle where to find classes
     * @param clazz  type classes must be assignable from
     */
     ...
     *
     * @param clazz superclass to cast as
     */
    ...
    private static String toStringAndClose(InputStream input) throws IOException {
