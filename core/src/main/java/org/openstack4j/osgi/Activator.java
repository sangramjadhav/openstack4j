...
public class Activator implements BundleActivator {
    ...
    private ServiceTracker connectorsTracker = null;
    ...
    public void start(BundleContext context) throws Exception {
        ...
        connectorsTracker = new ServiceTracker(context, HttpExecutorService.class.getName(), null) {
            @Override
     ...
     * @throws Exception If this method throws an exception, the bundle is still marked as stopped, and the Framework will
    ...
    public void stop(BundleContext context) throws Exception {
        ...
        if (connectorsTracker != null) {
            connectorsTracker.close();
        }
    }
}